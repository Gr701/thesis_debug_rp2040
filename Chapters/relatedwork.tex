...
The TKJHAT is an open-source, open-hardware HAT platform designed by members of the Faculty of Information Technology and Electrical Engineering and implemeted to support IoT and embedded systems education in two courses, 521286A Computer Systems and 521287A Introduction to Computer Systems that correspond to 8 and 5 ECTS, respectively. The platform itself was developed on top
...
\begin{enumerate}
    ...
    \item IMU (ICM-42670, accelerator and gyroscope)
    \item OLED display (SSD1306)
\end{enumerate}
