...
The TKJHAT is an open-source, open-hardware Hardware Attached on Top (HAT) platform designed by members of the Faculty of Information Technology and Electrical Engineering and implemeted to support IoT and embedded systems education in two courses, 521286A Computer Systems and 521287A Introduction to Computer Systems that correspond to 8 and 5 ECTS, respectively. The platform itself was developed on top
of the Raspberry Pi Pico W and FreeRTOS with a diverse and multifaceted array of peripheral devices built in that enables particpating students to experiment and derive solutions to complex problems presented during course. The peripherals present in the TKJHAT are connected in two different ways; via GPIO pins and $\text{I}^2\text{C}$. Peripherals connected via $\text{I}^2\text{C}$ include the following:
