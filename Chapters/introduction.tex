...
The final implementation includes the docker container with the software environment and the physical enclosure for the tools used in the course to facilitate students' tasks. The links to the design and implementation documents can be found in Appendix 1 of this thesis. TODO put links in appendix
